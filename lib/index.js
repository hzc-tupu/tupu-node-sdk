...
function TUPU(secretId, privateKeyPath, options) {
    ...
    const prefixV4 = 'http://' + domain + '/v4/recognition/'
    this.imageApi = prefix + secretId
    this.videoSyncApi = prefixV4 + 'video/syncscan/' + secretId
    this.videoAsyncApi =  prefixV4 + 'video/asyncscan/' + secretId
    this.videoStreamApi = prefixV4 + 'video/stream/' + secretId
    this.videoCloseApi = prefixV4 + 'video/close/' + secretId
